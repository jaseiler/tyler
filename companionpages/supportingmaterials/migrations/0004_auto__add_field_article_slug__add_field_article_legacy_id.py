...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'supportingmaterials_article', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2013, 9, 12, 0, 0), unique=True, max_length=50),
                      keep_default=False)

        # Adding field 'Article.legacy_id'
        db.add_column(u'supportingmaterials_article', 'legacy_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'supportingmaterials_article', 'slug')

        # Deleting field 'Article.legacy_id'
        db.delete_column(u'supportingmaterials_article', 'legacy_id')
